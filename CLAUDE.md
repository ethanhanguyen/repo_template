...
2. Read `docs_template/plans/progress.md`
3. Read `docs_template/navigation.md`
4. Read `docs_template/archive/learnings.md` (last 30 lines)

### Close
1. Update `docs_template/navigation.md` — Current focus + Scout corrections (grep shortcuts, anti-patterns, better search strategies)
2. Log learnings to `docs_template/archive/learnings.md`
